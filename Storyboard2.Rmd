...
leaflet() %>% setView(-1.161877,52.350304, 6) %>% #setView gives centre coordinates and zoom level
  ...
  addPolygons(data = pc_data1, stroke = T, color = ~factpal(pc_data1$ntile),opacity = 1, fillOpacity = 1, label = labels1)  %>% 
...
leaflet() %>% setView(-1.161877,52.350304, 6) %>% #setView gives centre coordinates and zoom level
  setMapWidgetStyle(list(background = "white")) %>%  
  addPolygons(data = pc_data3, stroke = T, color = ~factpal(pc_data3$ntile),opacity = 1, fillOpacity = 1, label = labels3)  %>% 
  addLegend(pal = factpal3, values = pc_data3$ntile, labels=pc_data3$ntile, opacity=1, position = "bottomright" , title="Ranking quintiles") %>% 
  removeDrawToolbar(clearFeatures = T) 
...
leaflet() %>% setView(-1.161877,52.350304, 6) %>% #setView gives centre coordinates and zoom level
  setMapWidgetStyle(list(background = "white")) %>%  
  addPolygons(data = pc_data4, stroke = T, color = ~factpal(pc_data4$ntile),opacity = 1, fillOpacity = 1, label = labels4)  %>% 
  addLegend(pal = factpal4, values = pc_data4$ntile, labels=pc_data4$ntile, opacity=1, position = "bottomright" , title="Ranking quintiles") %>% 
  removeDrawToolbar(clearFeatures = T) 
```
...
leaflet() %>% setView(-1.161877,52.350304, 6) %>% #setView gives centre coordinates and zoom level
  setMapWidgetStyle(list(background = "white")) %>%  
  addPolygons(data = pc_data5, stroke = T, color = ~factpal(pc_data5$ntile),opacity = 1, fillOpacity = 1, label = labels5)  %>% 
...
leaflet() %>% setView(-1.161877,52.350304, 6) %>% #setView gives centre coordinates and zoom level
  setMapWidgetStyle(list(background = "white")) %>%  
  addPolygons(data = pc_data6, stroke = T, color = ~factpal(pc_data6$ntile),opacity = 1, fillOpacity = 1, label = labels6)  %>% 
...
leaflet() %>% setView(-1.161877,52.350304, 6) %>% #setView gives centre coordinates and zoom level
  setMapWidgetStyle(list(background = "white")) %>%  
  addPolygons(data = pc_data7, stroke = T, color = ~factpal(pc_data7$ntile),opacity = 1, fillOpacity = 1, label = labels7)  %>% 
